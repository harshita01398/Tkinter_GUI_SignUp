...
class StartPage(tk.Frame):
    def __init__(self,parent,controller):
        ...
        text1 = "New user?\nRegister here"       	
        button1 = tk.Button(self, text=text1,font=("Calisto MT",12),command = lambda: controller.show_frame(RegisterPage),activebackground="white",
        	                relief=tk.RAISED,width = 15,bg="darkorange3")
        button1.pack()
        
        text2 = "Existing user?\nLog In" 
        button2 = tk.Button(self, text=text2,font=("Calisto MT",12), command=lambda: controller.show_frame(LoginPage), activebackground="white",
                            relief=tk.RAISED,width = 15,bg="darkorange3")
        button2.pack()
...
class RegisterPage(tk.Frame):
    def __init__(self,parent,controller):
        ...
        button1 = tk.Button(self, text="Submit",font=("Calisto MT",12),command = lambda: self.reg_status(controller,dict_ent),
                            activebackground="light cyan",relief=tk.RAISED,width = 15)
        button1.grid(row=13,column=23)

        button2 = tk.Button(self, text="Reset",font=("Calisto MT",12),command = lambda: reset_field([e1,e2,e3,ep1,ep2]),activebackground="light cyan",
                             relief=tk.RAISED,width = 15)
        button2.grid(row=13,column=24)
        button2 = tk.Button(self, text="Already registered? Log in Here",font=("Calisto MT",12),command = lambda: [controller.show_frame(LoginPage),reset_field([e1,e2,e3,ep1,ep2])],activebackground="light cyan",
...
class LoginPage(tk.Frame):
    def __init__(self,parent,controller):
        ...
        button1 = tk.Button(self, text="Login",font=("Calisto MT",12),command =lambda: self.log_status(controller,ldict_ent),activebackground="light cyan",
                             relief=tk.RAISED,width = 15)
        button1.grid(row=10,column=11)
        
        button2 = tk.Button(self, text="New User? Register",font=("Calisto MT",12),command = lambda: controller.show_frame(RegisterPage),activebackground="light cyan",
                             relief=tk.RAISED,width = 15)
